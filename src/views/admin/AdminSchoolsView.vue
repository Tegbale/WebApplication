      ...
      <div v-else>
        <BaseDataTable class="hidden md:block">
          ...
          <template #table-body>
            <template v-if="SchoolLists && SchoolLists.length > 0">
              <tr class="border-b-2 border-gray-100 hover:bg-gray-50" v-for="(school, i) in SchoolLists" :key="school.id">
                <td class="p-3 text-sm text-tegbale-text-gray font-roboto">
                  {{ i + 1 }}
                </td>
                <td class="p-3 text-sm text-tegbale-text-gray font-roboto">{{ school.name }}
                </td>
                <td class="p-3 text-sm text-tegbale-text-gray font-roboto">
                  {{ school.contact_name }}
                </td>
                ...
                <td class="flex justify-end p-3 space-x-2">
                  <button @click="handleViewSchool(school.id)"
                  ...
                  <button @click="handleEditSchool(school.id)"
                  ...
                  <button @click="handleDeleteSchool(school.id)"
        ...
        <template v-if="SchoolLists && SchoolLists.length > 0">
          <div class="grid grid-auto-fit gap-4 md:hidden pt-4" v-for="school in SchoolLists" :key="school.id">
            <BaseMobileDataTable :column-one-text="school.name" :column-two-text="school.contact_name"
              :column-three-text="school.contact_email"  column-one-title="School Name" column-two-title="Admin"
    ...
    <BaseModal :modalActive="modalActive" :closeMode="closeModal">
            ...
            <div>
              ...
              <div class="relative flex items-center text-gray-300 focus-within:text-tegbale-blue"
                ...
                <select v-model="schoolData.adminname" :disabled="modalTitle === 'View School'"
                  ...
                  <option v-for="user in usersStore.schooladmin" :value="user.fullname" :key="user.fullname">
                    {{ user.fullname }}
                  </option>
                </select>
              </div>
      ...
      <template #button>
        <div class="block md:flex items-center md:justify-end md:space-x-4 space-y-3 md:space-y-0 py-10">
          <button @click.prevent="triggerDeleteModal" :loading="isLoading" v-if="modalTitle == 'View School'"
