  ...
  <div>
    <div>
      ...
      <BaseDataTable class="hidden md:block">
        ...
        <template #table-body>
          <template v-if="adminStore && adminStore.allUsers.length > 0">
            <tr class="border-b-2 border-gray-100" v-for="(user, i) in adminStore.allUsers" :key="i">
              ...
              <td class="flex justify-end p-3 space-x-2">
                <button @click="handleViewUser(user.id)"
      ...
      <!-- Mobile design  -->
      <template v-if="adminStore && adminStore.allUsers.length > 0">
        <div class="grid grid-auto-fit gap-4 md:hidden pt-4" v-for="(user, i) in adminStore.allUsers" :key="i">
    ...
    <BaseModal :modalActive="modalActive" :closeMode="closeModal">
      ...
      <template #form>
        <form>
          ...
          <div class="grid grid-auto-fit gap-3 ">
            <div>
              <BaseInput label="Full Name" placeholder="Enter Full Name" type="text" class="w-full"
                :modalInput="modalInput" v-model="newUser.fullname" />
              <span v-if="v$.fullname.$errors.length > 0" class="text-red-500 text-sm pl-4">
                {{ v$.fullname.$errors[0].$message }}
              </span>
            </div>
            <div>
              <BaseInput label="Email Address" placeholder="Enter Email Address" type="email" class="w-full"
                :modalInput="modalInput" v-model="newUser.email" />
              <span v-if="v$.email.$errors.length > 0" class="text-red-500 text-sm pl-4">
            ...
            <div>
              ...
              <span v-if="v$.password.$errors.length > 0" class="text-red-500 text-sm pl-4">
            ...
            <div class="grid grid-auto-fit gap-3">
              <div>
                <BaseInput label="Phone Number" placeholder="Enter Phone Number" type="text" class="w-full"
                  :modalInput="modalInput" v-model="newUser.phone" />
                <span v-if="v$.phone.$errors.length > 0" class="text-red-500 text-sm pl-4">
              ...
              <div>
                ...
                <span v-if="v$.role.$errors.length > 0" class="text-red-500 text-sm pl-4">
      ...
      <template #button>
        <div class="block md:flex items-center md:justify-end md:space-x-4 space-y-3 md:space-y-0 py-10">
          <button v-if="modalTitle == 'View User'"
          ...
          <button :disabled="v$.$invalid" @click.prevent="saveUser"
            class="text-white font-medium font-roboto py-2 px-10 w-full md:max-w-fit rounded-3xl" :class="
              v$.$invalid
