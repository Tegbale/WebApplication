        ...
        <div class="flex items-center justify-between">
          <div class="flex flex-1 items-center">
            <div class="flex flex-1 justify-between items-center">
              <div class="logo-wrapper p-2 flex-1" @click.prevent="isOpen = true">
                <div
              ...
              <div @click.prevent="isOpen = false"
        ...
        <nav class="mt-10">
          <ul class="flex flex-1 flex-col space-y-4">
            <li class="flex-1 items-center">
              <router-link to="/dashboard" active-class="bg-tegbale-blue text-white rounded-xl"
                ...
                <span class="flex justify-center items-center">
                  <svg width="10" height="10" viewBox="0 0 20 20" fill="currentColor" xmlns="http://www.w3.org/2000/svg"
                    class="w-5 h-5">
                    <path
                  ...
                  <span class="mx-4 text-base font-normal font-roboto">Dashboard</span>
                </span>
              </router-link>
            </li>
            <li class="flex-1 items-center">
              <router-link to="/classrooms" :class="activeClass"
                ...
                <span class="flex justify-center items-center">
                  ...
                  <span class="mx-4 text-base font-normal font-roboto">Classrooms</span>
                </span>
              </router-link>
            </li>
            <li class="flex-1 items-center">
              <router-link to="/teachers" active-class="bg-tegbale-blue text-white rounded-xl"
                class="flex items-center pl-4 pr-4 py-2 text-tegbale-text-gray w-full, hover:bg-tegbale-blue hover:text-white hover:rounded-xl">
                <span class="flex justify-center items-center">
                  ...
                  <span class="mx-4 text-base font-normal font-roboto">Teachers</span>
                </span>
              </router-link>
            </li>

            <li class="flex-1 items-center">
              <router-link active-class="bg-tegbale-blue text-white rounded-xl" to="/students"
                class="flex items-center pl-4 pr-4 py-2 text-tegbale-text-gray w-full, hover:bg-tegbale-blue hover:text-white hover:rounded-xl">
                <span class="flex justify-center items-center">
                  <svg width="35" height="20" viewBox="0 0 35 20" fill="currentColor" xmlns="http://www.w3.org/2000/svg"
                    class="w-5 h-5">
                    <path
                  ...
                  <span class="mx-4 text-base font-normal font-roboto">Students</span>
                </span>
              </router-link>
            </li>
            <!-- <li class="flex-1 items-center">
              <router-link active-class="bg-tegbale-blue text-white rounded-xl" to="/guardians"
                class="flex items-center pl-4 pr-4 py-2 text-tegbale-text-gray w-full, hover:bg-tegbale-blue hover:text-white hover:rounded-xl">
                <span class="flex justify-center items-center">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                  ...
                  <span class="mx-4 text-base font-normal font-roboto">Guardians</span>
                </span>
              </router-link>
            </li> -->
            <li class="flex-1 items-center">
              <router-link active-class="bg-tegbale-blue text-white rounded-xl" to="/settings"
                class="flex items-center pl-4 pr-4 py-2 text-tegbale-text-gray w-full, hover:bg-tegbale-blue hover:text-white hover:rounded-xl">
                <span class="flex justify-center items-center">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                    stroke="currentColor" class="w-5 h-5">
                  ...
                  <span class="mx-4 text-base font-normal font-roboto">Settings</span>
                </span>
              </router-link>
            </li>
          </ul>
          ...
          <ul>
            <li class="flex-1 items-center">
              <button @click.prevent="logout"
                ...
                <span class="flex justify-center items-center">
                  <svg width="20" height="20" viewBox="0 0 20 20" fill="#D00808" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <span class="mx-4 text-base font-normal font-roboto">Logout</span>
                </span>
              </button>
            </li>
          </ul>
      ...
      <div class="flex w-full items-center bg-white border-b fixed z-50">
        ...
        <nav
          ...
          <div class="w-full sm:w-[30%] max-w-2xl">
            <form action="">
              <div class="relative w-full flex items-center text-tegbale-text-gray focus-within:text-transparent">
                ...
                <div class="absolute hidden sm:block pointer-events-none">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                    stroke="currentColor" class="w-6 h-6 ml-1 pointer-events-none">
                    <path stroke-linecap="round" stroke-linejoin="round"
...
// computed property to check if the route has classroom as part of its path
const activeClass = computed(() => {
  // Check if the route path contains '/classrooms'
  if (route.path.includes('/classrooms')) {
    return 'bg-tegbale-blue text-white rounded-xl';
  }
  // Return default class or an empty string if needed
  return '';
});
