      ...
      <div class="flex flex-col flex-1 justify-center">
        <ul>
          <li class="flex-1 items-center">
            <router-link
              to="/admin/dashboard"
              class="flex items-center pl-4 pr-4 py-2 text-tegbale-text-gray w-80, hover:bg-red-100 hover:text-white hover:rounded-xl"
            >
              <span class="flex justify-center items-center">
                <svg
                  width="20"
                ...
                <span
                  class="mx-4 text-base font-normal font-roboto text-[#D00808]"
                  >Logout</span
                >
              </span>
            </router-link>
